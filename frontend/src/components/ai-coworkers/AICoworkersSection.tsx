...
export function AICoworkersSection({ onCreateAICoworker }: AICoworkersSectionProps) {
  const [aiCoworkers] = useState<AICoworker[]>(mockAICoworkers);
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-flextide-neutral-border sticky top-0 bg-flextide-neutral-panel-bg z-10">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              aria-label="Filter AI coworkers"
            >
              <svg
                className="w-5 h-5"
                fill="none"
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-4 text-xs text-flextide-neutral-text-medium">
                    <div>
                      ...
                      <div>{formatDate(aiCoworker.lastModified)}</div>
                    </div>
                    <div>
                      <div className="font-medium mb-1">Next Execution</div>
                      <div>{formatDate(aiCoworker.nextExecution)}</div>
                    </div>
                    <div>
                      <div className="font-medium mb-1">Last Execution</div>
                      <div>{formatDate(aiCoworker.lastExecution)}</div>
                    </div>
                  </div>
                </div>
              ))}
