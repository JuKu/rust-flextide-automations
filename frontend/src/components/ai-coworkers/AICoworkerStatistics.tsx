...
interface AICoworkerStatisticsProps {
  statistics?: Statistic[];
}

const defaultStatistics: Statistic[] = [
  {
    label: "AI Coworker Executions this month",
    value: "150",
    icon: (
      <svg
        className="w-5 h-5"
  ...
  {
    label: "AI Coworker Execution time this month",
    value: "25 minutes",
    icon: (
      <svg
        className="w-5 h-5"
  ...
  {
    label: "Storage Costs this month",
    value: "20€",
    icon: (
      <svg
        className="w-5 h-5"
...
export function AICoworkerStatistics({
  statistics = defaultStatistics,
}: AICoworkerStatisticsProps) {
  return (
    <div className="rounded-lg bg-flextide-neutral-panel-bg border border-flextide-neutral-border p-6 shadow-sm">
      ...
      <div className="space-y-4">
        {statistics.map((stat, index) => (
          <div
            key={index}
            className="flex items-center justify-between py-2 border-b border-flextide-neutral-border last:border-b-0"
          >
